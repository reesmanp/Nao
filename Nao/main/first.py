...
rpos = ALProxy("ALRobotPosture", ip, 9559)
motionProxy.moveInit()
rpos.goToPosture("Stand", 1.0, 1)
...
motionProxy.moveTo(0, robotToLandmark.r2_c4, 0)
motionProxy.moveTo(0, 0, ((robotToLandmark.r2_c4 / 1.06) * 5))
